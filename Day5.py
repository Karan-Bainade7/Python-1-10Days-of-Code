...
it emphasizes code clarity and productivity.
Python supports multiple programming paradigms, 
including procedural, object-oriented, and functional programming. 
Its extensive standard library and active community make it ideal for a wide range of applications, such as web development, data analysis, artificial intelligence, machine learning, automation, and more. 
It is widely used due to its ease of learning and versatility.'''

print("hello guys,\ni am karan bainade. i am an Developer\ni am learning python")